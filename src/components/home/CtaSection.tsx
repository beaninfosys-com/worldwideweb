    ...
    <PageSection invertColors={invertColors}>
      <div className="max-w-5xl mx-auto text-center">
        <ScrollAnimator animation="fade-in">
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-tick-blue">Ready for an AI-Powered Digital Transformation?</h2>
        </ScrollAnimator>
        <ScrollAnimator animation="fade-in" delay={200}>
          <p className={`text-lg ${invertColors ? "text-black/70" : "text-foreground/70"} mb-8`}>
            Let's discuss how Bean Infosystems can help your business thrive with AI capabilities.
          </p>
        </ScrollAnimator>
